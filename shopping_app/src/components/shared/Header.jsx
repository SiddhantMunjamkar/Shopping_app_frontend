...
import {
  HiPencilAlt as EditActiveIcon,
  HiOutlinePencilAlt as EditInactiveIcon,
} from "react-icons/hi";
        ...
        <Menu as="div" className="relative inline-block text-left">
          <div>
            <Menu.Button className="ml-2  inline-flex rounded-full focus:outline-none focus:ring-2 focus:ring-neutral-400 ">
              <span className="sr-only"> Open User only</span>
              <div
                className="h-10 w-10 rounded-full bg-sky-500 bg-cover bg-no-repeat bg-center"
                style={{
                  backgroundImage: 'url("/Images/gojo_sataru.png ")',
                }}
              >
                <span className="sr-only"> Siddhant Munjamkar </span>
              </div>
            </Menu.Button>
          </div>
          <Transition
